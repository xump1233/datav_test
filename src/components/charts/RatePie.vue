...
export default {
    ...
    methods:{
        setChart(){
            ...
            const rate1 = (this.chartData.male/this.chartData.female).toFixed(2)
            const value1 = ((this.chartData.male/this.getTotal)*100).toFixed(0)
            const value2 = ((this.chartData.female/this.getTotal)*100).toFixed(0)
            const colorList={
                '男':'#00d488',
                '女':'#3feed4'
            }
            let option = {
                ...
                tooltip:{
                    ...
                    formatter: function (params) {
                        return ''+params.name + ' : '+ Math.floor(Number(params.value)*all/100);
                    }
                }
                ,
                grid: {
